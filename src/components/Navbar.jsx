...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between  items-center h-44 max-w-[1240px] mx-auto px-4'>
      <h1 className='w-full text-3xl font-bold text-[#1e40af]'>WATERFORD KHAMLABA</h1>
      ...
      <ul className='hidden md:flex cursor-pointer '>
        ...
        <div className={nav ? "fixed left-0 top-0 w-[60%] h-full border-r-gray-900 bg-slate-300 ease-in-out duration-500 " : "ease-in-out duration-500 fixed left-[-100%]"}>
        <h1 className='w-full text-3xl font-bold text-[#1e40af] m-4 '>REACT</h1>
